...
if vim.g.vscode then
  ...
  local lsp_by_ft = {
    ...
    gotmpl = { "gopls" },
    rust = { "rust-analyzer" },
    javascript = { ts_server, "biome", "tailwindcss" },
    javascriptreact = { ts_server, "biome", "tailwindcss" },
    typescript = { ts_server, "biome", "tailwindcss" },
    typescriptreact = { ts_server, "biome", "tailwindcss" },
    vue = { "tailwindcss" },
    svelte = { "tailwindcss" },
    astro = { "tailwindcss" },
    mdx = { "tailwindcss" },
