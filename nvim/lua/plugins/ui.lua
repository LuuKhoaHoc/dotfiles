...
return {"nvim-lua/plenary.nvim", {
    ...
    config = function()
        require("colorizer").setup({"*" -- Highlight all file types
        }, {
        ...
        content = {
            active = function()
                ...
                }, "%=", -- End left alignment
                {
                    ...
                    strings = {vim.bo.filetype ~= "" and require("mini.icons").get("filetype", vim.bo.filetype) .. " " ..
                        vim.bo.filetype}
                }, {
                    hl = mode_hl,
                    strings = {"%l:%v"}
        ...
        overrides = function(colors)
            ...
            return {
                ...
                SnacksProfilerBadgeInfo = {
                    bg = theme.ui.bg_visual,
                    fg = theme.syn.fun
                },
                SnacksScratchKey = {
                    link = "SnacksProfilerIconInfo"
                },
                SnacksScratchDesc = {
                    link = "SnacksProfilerBadgeInfo"
                },
