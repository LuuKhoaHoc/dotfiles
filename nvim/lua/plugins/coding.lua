...
return { -- Treesitter config: đảm bảo đủ parser cần thiết
{
    "nvim-treesitter/nvim-treesitter",
    build = ":TSUpdate",
    event = {"BufReadPost", "BufNewFile"},
    opts = {
        ensure_installed = {"css", "html", "javascript", "latex", "norg", "scss", "svelte", "tsx", "typst", "vue",
                            "regex"}
    }
}, -- Setup Copilot
{
...
}, -- Surround text objects with pairs of characters
{
