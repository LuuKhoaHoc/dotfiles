---
name: pr-review
description: Review branch/PR/MR changes with a senior-engineering lens — correctness, security, edge cases, maintainability, test coverage. Use when user says "review this", "review the MR", "check my changes", "before merge", or wants thorough QA review of a diff or branch.
---

# PR Review

Review changes like a senior engineer who will maintain the code.
...
- User asks whether this looks right about a diff/change
...
Apply these as review criteria:
...
- Could a large block be smaller and clearer?
...
| Nitpick naming in a 5-line MR | Reserve nitpicks for large reviews |
